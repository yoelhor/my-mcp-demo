...
This project is based on the official [ASP.NET Core extensions for the MCP C# SDK](https://github.com/modelcontextprotocol/csharp-sdk/tree/main/samples/ProtectedMcpServer) **ProtectedMcpServer** sample.
...
- **MCP Endpoint**: <https://localhost:7221/> (requires authentication)
- **OAuth Resource Metadata**: <https://localhost:7221/.well-known/oauth-protected-resource>
